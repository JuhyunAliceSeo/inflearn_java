...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%6d%n", 1234); // __1234 -> 6만큼의 공간을 먼저 만들고 거기에 1234를 출력
        System.out.printf("%06d%n", 1234); // 001234 -> 6자리의 공간 확보 후 1234 출력하는데 빈공간은 0으로 출력함
        System.out.printf("%6d%n", -1234); // _-1234
        System.out.printf("%+6d%n", 1234); // _+1234 (항상 기호 표시(
        System.out.printf("%,15d%n", 1000000000); // __1,000,000,000 -> 세자리마다 , 표시
        System.out.printf("%-6d%n", 1234); //1234__ --> 6자리의 공간 확보 후 1234 출력하는데 왼쪽정렬ㅇ로 출력함

        System.out.println("--------- 실수 ----------");
        System.out.printf("%f%n", Math.PI); // 3.141593 (일반 출력)
        System.out.printf("%.2f%n", Math.PI); // 3.14 (소수점 둘쨰자리)
        System.out.printf("%6.2f%n", Math.PI); // __3.14 (6ㅏ리 공간 확보하고 소수점 둘째자리)
        ...
        System.out.printf("%6.2s%n", "Java"); //____Ja (6자리 공간 확보하고 우측 정렬해서 2글자출력)
        System.out.printf("%-6.2s%n", "Java"); //Ja____ (6자리 공간 확보하고 좌측 정렬해서 2글자출력)
        ...
        System.out.println("이름      영어   수학   평균"); //공맥이 각각 6,3,3칸으로 구분
