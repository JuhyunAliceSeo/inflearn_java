...
public class _01_Input {
    public static void main(String[] args) {
        //사용자 입력
        Scanner sc = new Scanner(System.in); //사용자로부터 받는다
//        System.out.println("이름을 입력하세요");
//        String name = sc.next();
//        System.out.println("혈액형을 입력하세요");
//        String bloodType = sc.next();
//        System.out.println("키을 입력하세요");
//        //int height = Integer.parseInt(sc.next()); //스캐너는 항상 문자형태로 받기때문에 인트로 변환을 해줘야함
...
//        System.out.println("몸무게 : " + weight);
        ...
        //String lang = sc.nextLine(); //-> 한문장으로 받을수 있음.
        ...
        String feeling = sc.nextLine(); // 한문장 (재밌었어요)
