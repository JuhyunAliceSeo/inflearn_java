...
public class _04_Operator4 {
    public static void main(String[] args) {
        ...
        System.out.println(김치찌개 && 계란말이 && 제육볶음); //하나라도 false 이면 false (==and)
        ...
        System.out.println((5 < 3) || (3 < 1)); //5는 3보다 작거나, 3은 1보다 작다(true)

        //System.out.println(1 < 3 < 5); -->불가능한 코드임 3개를 연달아 쓰면 안됨
