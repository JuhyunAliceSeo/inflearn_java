...
public class _01_Array {
    public static void main(String[] args) {
        // 배열 : 같은 자료형의 값 여러 개를 저장하는 연속된 공간(like 공항의자)
        ...
        //배열 선언 첫번째 방법
        //String[] coffees = new String[4]; //크기가 4개인 String 배열 coffeees를 만듬

        //배열 선언 두번쨰 방법
        //String coffees[] = new String[4];
        /* coffees[0] = "아메리카노"; //0(index값)에 아메리카노를 넣음
        coffees[1] = "카페모카";
        coffees[2] = "라떼";
        coffees[3] = "카푸치노"; */
        ...
        System.out.println(coffees[2] + " 하나"); //라뗴 하나
